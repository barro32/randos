...
class GameController {
    ...
    /**
     * Sort players by gold only (lowest first, highest last)
     * This ensures players with least gold get shopping priority
     */
    private sortPlayersByGold(players: Player[]): Player[] {
